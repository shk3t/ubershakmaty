...
На данной странице можно посмотреть, кто занимает лидирующие позиции. Кроме того, к странице доски подключен Header.jsx, который сможет переадресовать вас на необходимые страницы, такие как " Главная",  "Настройки" и др
