          ...
          <tbody>
            {gamesData["last_games"] === undefined
              ...
              : gamesData["last_games"].map((val, key) => {
                  const is_winner =
                    ((val.white_player__id__nickname === authUser.nickname) &&
                      (val.result === 1)) ||
                    ((val.black_player__id__nickname === authUser.nickname) &&
                      (val.result === -1))
                  ...
                  return (
                    <tr key={key}>
                      <td>
                        {val.white_player__id__nickname === authUser.nickname
                          ? val.black_player__id__nickname
                          : val.white_player__id__nickname}
                      </td>
                      <td
                        className={
                          is_winner
